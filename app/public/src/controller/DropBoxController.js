class DropBoxController {
    ...
    constructor() {
        ...
        //Atributos para resgate de valores de campos em HTML pelo ID ou Classe
    ...
    connectFirebase() {
        var firebaseConfig = {
            ...
            projectId: "drop-clone-project",
            storageBucket: "drop-clone-project.appspot.com",
            messagingSenderId: "248957839588",
            appId: "1:248957839588:web:fd0d5e560cedf10d6d64f1"
        };
        // Initialize Firebase
    ...
    //Envio de arquivo usando Ajax e promises
    uploadTask(files) {

        let promises = [];
        //Spread usado para percorrer o tanto de arquivos do input - Colections
        [...files].forEach(file => {
